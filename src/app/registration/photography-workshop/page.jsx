  ...
  const handlePayment = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/payment/get_order`, {
        ...
        body: JSON.stringify({ amount: 150, currency: "INR", receipt: `photography_${Date.now()}` })
      })
      ...
      const options = {
        ...
        name: "CIT Immerse - Photography Workshop",
        ...
        handler: function (response) {
          ...
          window.location.href = `/success/photography-workshop?${query}`
        }
      }
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">
              Dive into the art of photography, learn lighting, framing, and post-processing techniques to turn ordinary moments into extraordinary visual stories.
            </p>
          </div>
