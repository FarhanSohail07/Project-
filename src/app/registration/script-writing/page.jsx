  ...
  const handlePayment = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/payment/get_order`, {
        ...
        body: JSON.stringify({ amount: 150, currency: "INR", receipt: `scriptwriting_${Date.now()}` })
      })
      ...
      const options = {
        ...
        name: "CIT Immerse - Script Writing Workshop",
        description: "Creative Writing & Story Building Workshop",
        order_id: order.id,
        ...
        handler: function (response) {
          ...
          window.location.href = `/success/script-writing?${query}`
        }
      }
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 text-sm">
              Learn how to transform your imagination into powerful scripts. Discover storytelling, dialogue writing, and screenplay formatting from industry mentors.
            </p>
          </div>
